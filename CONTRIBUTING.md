...
Please read and understand the following before opening issues or pull requests.

### Best-Effort Maintenance

This project is maintained on a best-effort basis. We cannot guarantee timely responses, reviews, or merges for any contributions. Please be patient and understanding.

### Ubie's Interests Take Priority

n8n-cli is developed primarily to serve Ubie's internal needs. Contributions that do not align with Ubie's priorities may be declined or deprioritized, even if they are technically sound. We appreciate your understanding.

### AI-Generated Contributions

Contributions that appear to be generated by AI (e.g., large-scale automated PRs, low-context suggestions) may be closed without review or response, depending on their content and quality. This is to protect maintainers from burnout. If you use AI tools to assist your contribution, please ensure you fully understand and can explain every change you propose.
